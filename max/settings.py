...
ROOT_URLCONF = "max.urls"  # Updated to point to max folder
...
WSGI_APPLICATION = "max.wsgi.application"  # Updated to point to max folder
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Added static files directories
